...
def get_model(img_shape=None, num_classes=1):
    ...
    conv3_1 = Conv2D(32, (3, 3), dilation_rate=4, padding='same', activation='relu')(pool1)
    conv3_skip = Conv2D(32, (1, 1), dilation_rate=4, padding='same', activation='relu')(pool1)
    conv3_2 = Conv2D(32, (3, 3), dilation_rate=4, padding='same', activation='relu')(conv3_1)
    add3 = Add()([conv3_2, conv3_skip])
    pool3 = MaxPooling2D(pool_size=(2, 2))(add3)
    ...
    conv6_1 = Conv2D(32, (3, 3), dilation_rate=2, padding='same', activation='relu')(skip_concat1)
    conv6_skip = Conv2D(32, (1, 1), dilation_rate=2, padding='same', activation='relu')(skip_concat1)
    conv6_2 = Conv2D(32, (3, 3), dilation_rate=2, padding='same', activation='relu')(conv6_1)
    add6 = Add()([conv6_2, conv6_skip])
    upsamp6 = UpSampling2D(size=(2, 2))(add6)
